...
test('Windnow Handling', async ({ browser }) => {
    ...
    await page.click('//h2[text()="Results"]//ancestor::div[@data-cel-widget="search_result_0"]//following-sibling::div[@data-asin="B0FQFW4MVJ"]//descendant::h2[contains(@aria-label,"Sponsored Ad - iPhone 17 Pro Max 256 GB: 17.42 cm (6.9″)")]')
    ])
    //Array          const arr=[10,20,30,40]
    // const [a]=arr
